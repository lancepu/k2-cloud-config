...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private static final String GET_ALL_CUSTOMER_SQL =
    ...
    public Customer getCustomer(int customerId) {
        try {
            return jdbcTemplate.queryForObject(GET_CUSTOMER_SQL, this::mapRowToCustomer, customerId);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public List<Customer> getAllCustomers() {
        return jdbcTemplate.query(GET_ALL_CUSTOMER_SQL, this::mapRowToCustomer);
    }
